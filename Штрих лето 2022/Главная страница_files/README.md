В папке Главная страница_files находятся контент, уникальный для Главная страница.html, то есть картинки и таблица стилей, которая нужна именно для этой страницы.
